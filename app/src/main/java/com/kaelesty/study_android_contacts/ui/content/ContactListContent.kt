...
@Composable
fun Contacts(
    contactsListComponent: ContactListComponent
) {
    val contacts by contactsListComponent.model.collectAsState()
    ...
    Box(
            ...
            items(
                ...
                Contact(
                    modifier = Modifier.clickable {
                        contactsListComponent.onEditContact(it)
                    },
        ...
        FloatingActionButton(
            ...
            onClick = {
                contactsListComponent.onAddContact()
            }
        ) {
            Image(
